...
SB_ROUTE_RESP_200 = {"status_code": 200, "json": _load_json("tests/data/route/route_sb.json"), "headers": HEADER_JSON}
...
SB_ROUTE_MP_RESP_200 = {"status_code": 200, "json": _load_json("tests/data/route/route_sb_mp.json"), "headers": HEADER_JSON}
HX_AIRPORT_RESP_200 = {"status_code": 200, "json": _load_json("tests/data/route/airport_hx.json"), "headers": HEADER_JSON}
...
AD_AIRPORT_RESP_200 = {"status_code": 200, "json": _load_json("tests/data/route/airport_ad.json"), "headers": HEADER_JSON}
